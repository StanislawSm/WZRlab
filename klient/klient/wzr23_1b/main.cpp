...
void VirtualWorldCycle()
{
	...
	{                              // nale¿y na nowo obliczyæ œredni czas cyklu avg_cycle_time
		...
		sprintf(text, "client id: %d (%0.0f fps  %0.2fms) ", my_car->iID, fFps, 1000.0 / fFps);
	...
	uni_send->send((char*)&frame, servAddr, sizeof(Frame));  // wys³anie komunikatu do pozosta³ych aplikacji
}
	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "client - wersja b", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
